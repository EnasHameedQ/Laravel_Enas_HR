...
<div class="col-9">
    ...
    <section class="resume-section" id="interests">
        <div class="resume-section-content">
            ...
            <p class="mb-0">When forced indoors, I follow a number of sci-fi and fantasy genre movies and television shows, I am an aspiring chef, and I spend a large amount of my free time exploring the latest technology advancements in the front-end web
                development world.
            </p>
        </div>
    </section>
...
<div class="download  col-2">
    <button class="btn">
        <i class="fa fa-download" aria-hidden="true"></i>Download <span class="badge success light">Download</span>
    </button>
</div>
@endsection